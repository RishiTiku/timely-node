  ...
  return new Promise((resolve, reject) => {
    pool.query(`
      CREATE TABLE IF NOT EXISTS LabBatches (
        ...
        BatchName VARCHAR(255) NOT NULL DEFAULT NULL,
  ...
  return new Promise((resolve, reject) => {
    pool.query(`
      CREATE TABLE IF NOT EXISTS Students_Subjects (
        UID INT NOT NULL,
        SubjectID INT NOT NULL,
        LectureBatchID INT NOT NULL,
        LabBatchID INT NOT NULL,
        PRIMARY KEY (UID, SubjectID),
        FOREIGN KEY (UID) REFERENCES user_data(college_uid) ON DELETE CASCADE,
